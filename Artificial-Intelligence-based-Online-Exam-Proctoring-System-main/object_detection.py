...
net = cv2.dnn.readNet("C:/Users/dasar/Downloads/Artificial-Intelligence-based-Online-Exam-Proctoring-System-main/Artificial-Intelligence-based-Online-Exam-Proctoring-System-main/object_detection_model/weights/yolov3-tiny.weights", 
                       "C:/Users/dasar/Downloads/Artificial-Intelligence-based-Online-Exam-Proctoring-System-main/Artificial-Intelligence-based-Online-Exam-Proctoring-System-main/object_detection_model/config/yolov3-tiny.cfg")

#classes that we have to detect using Object Detection Model
label_classes = []

with open("C:/Users/dasar/Downloads/Artificial-Intelligence-based-Online-Exam-Proctoring-System-main/Artificial-Intelligence-based-Online-Exam-Proctoring-System-main/object_detection_model/objectLabels/coco.names","r") as file:

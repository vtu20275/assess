...
shapePredictorModel = r'C:/Users/dasar/Downloads/Artificial-Intelligence-based-Online-Exam-Proctoring-System-main/Artificial-Intelligence-based-Online-Exam-Proctoring-System-main/shape_predictor_model/shape_predictor_68_face_landmarks.dat'
...
def head_pose_detection(faces, img):
    ...
    for face in faces:
        ...
        if ang1 >= 45:
            print(' ')
            cv2.putText(img, ' ', (50, 50), font, 2, (255, 255, 128), 2)
            return " "
        elif ang1 <= -45:
            print('')
            cv2.putText(img, ' ', (50, 50), font, 2, (255, 255, 128), 2)
        ...
        if ang2 >= 45:
            print('')
            cv2.putText(img, ' ', (50, 30), font, 2, (255, 255, 128), 2)
            return " "
        elif ang2 <= -45:
            print(' ')
            cv2.putText(img, ' ', (50, 30), font, 2, (255, 255, 128), 2)

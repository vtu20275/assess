...
predictorModel = r'C:/Users/dasar/Downloads/Artificial-Intelligence-based-Online-Exam-Proctoring-System-main/Artificial-Intelligence-based-Online-Exam-Proctoring-System-main/shape_predictor_model/shape_predictor_68_face_landmarks.dat'
...
def mouthTrack(faces, frame):
    ...
    for face in faces:
        ...
        if (dist > 23):
            cv2.putText(frame, " ", (50,80), cv2.FONT_HERSHEY_PLAIN,2,(0,0,255),2)
            return "Mouth Open"
        else:
            return "Mouth Close"
        return -1
